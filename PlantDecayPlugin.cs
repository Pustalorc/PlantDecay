...
public class PlantDecayPlugin : RocketPlugin<PlantDecayPluginConfiguration>
{
    ...
    protected override void Load()
    {
        ...
        Logger.Log("Plant Decay Plugin by Pustalorc has been loaded!");
    }
    ...
    protected override void Unload()
    {
        ...
        Logger.Log("Plant Decay Plugin by Pustalorc has been unloaded!");
    }
}